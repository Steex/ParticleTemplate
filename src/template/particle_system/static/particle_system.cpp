...
ParticlesStatic::ParticleSystem::ParticleSystem(iXml *_xml)
    : param_info      ()
    , emitter         (nullptr)
...
ParticlesStatic::ParticleSystem::~ParticleSystem()
{
...
Bool ParticlesStatic::ParticleSystem::isActive() const
{
...
void ParticlesStatic::ParticleSystem::start()
{
...
void ParticlesStatic::ParticleSystem::pause()
{
...
void ParticlesStatic::ParticleSystem::resume()
{
...
void ParticlesStatic::ParticleSystem::update(Float _tick)
{
...
void ParticlesStatic::ParticleSystem::inspect(Inspector *_inspector) const
{
