...
static const ParticlesStatic::EmitShapeRegistrator<ParticlesStatic::EmitShape_Rect> registrator("rectangle");



ParticlesStatic::EmitShape_Rect::EmitShape_Rect(iXml *_xml)
...
ParticlesStatic::EmitShape::Placement ParticlesStatic::EmitShape_Rect::create(Float _norm_emit_time)
{
    Placement placement;
