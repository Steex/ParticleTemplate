...
ParticlesStatic::Emitter::Emitter(iXml *_xml, ParamInfoHolder& _param_info)
...
ParticlesStatic::Emitter::~Emitter()
{
}



void ParticlesStatic::Emitter::createParticle(Byte *_data, Float _norm_emit_time)
{
