#ifndef _PSYS_STATIC_PROCESSOR_ACCELERATION_INCLUDED_
#define _PSYS_STATIC_PROCESSOR_ACCELERATION_INCLUDED_
...
#endif // _PSYS_STATIC_PROCESSOR_ACCELERATION_INCLUDED_
