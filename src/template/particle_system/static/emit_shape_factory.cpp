...
ParticlesStatic::EmitShapeFactory::EmitShapeFactory()
    : creators ()
{
}
...
ParticlesStatic::EmitShapeFactory* ParticlesStatic::EmitShapeFactory::inst()
{
...
void ParticlesStatic::EmitShapeFactory::registerCreator(const String& _type, EmitShapeCreator _creator)
{
...
ParticlesStatic::EmitShape* ParticlesStatic::EmitShapeFactory::create(iXml *_xml)
{
